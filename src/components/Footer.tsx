        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/thuc-pham-chuc-nang" className="hover:text-blue-200">
                  Thực Phẩm Chức Năng
                </Link>
              </li>
              <li>
                <Link to="/me-va-be" className="hover:text-blue-200">
                  Mẹ Và Bé
                </Link>
              </li>
              <li>
                <Link to="/sua-bot" className="hover:text-blue-200">
                  Sữa Bột
                </Link>
              </li>
              <li>
                <Link to="/cham-soc-ca-nhan" className="hover:text-blue-200">
                  Chăm Sóc Cá Nhân
                </Link>
              </li>
              <li>
                <Link to="/duoc-my-pham" className="hover:text-blue-200">
                  Dược Mỹ Phẩm
                </Link>
              </li>
              <li>
                <Link to="/goc-suc-khoe" className="hover:text-blue-200">
                  Góc Sức Khỏe
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/huong-dan-mua-hang" className="hover:text-blue-200">
                  Hướng Dẫn Mua Hàng
                </Link>
              </li>
              <li>
                <Link to="/chinh-sach-doi-tra" className="hover:text-blue-200">
                  Chính Sách Đổi Trả
                </Link>
              </li>
              <li>
                <Link to="/chinh-sach-van-chuyen" className="hover:text-blue-200">
                  Chính Sách Vận Chuyển
                </Link>
              </li>
              <li>
                <Link to="/chinh-sach-bao-mat" className="hover:text-blue-200">
                  Chính Sách Bảo Mật
                </Link>
              </li>
              <li>
                <Link to="/lien-he" className="hover:text-blue-200">
                  Liên Hệ
                </Link>
              </li>
            </ul>
